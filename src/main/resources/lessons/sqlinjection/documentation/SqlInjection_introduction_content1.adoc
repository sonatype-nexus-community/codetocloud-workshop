...
If you are still struggling with SQL and need more information or practice, you can visit https://www.sqlcourse.com/ for free and interactive online training.
