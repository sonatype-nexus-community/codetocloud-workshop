...
format: `https://example.com/file=report.pdf` now as an attacker, you are interested in other files, of course, so
you try `https://example.com/file=../../../../../etc/passwd.` In this case, you try walking up to the root of the filesystem
